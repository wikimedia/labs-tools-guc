...
class Contribs {
	 ...
	 * @param bool $isSingleIp
	 * @param Wiki $wiki
	 * @param stdClass|false $centralAuth
	 * @param array $options
	 */
	public function __construct( App $app, $user, $isSingleIp, Wiki $wiki, $centralAuth, $options = [] ) {
		if ( $user === '' ) {
